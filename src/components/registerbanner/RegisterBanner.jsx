                ...
                <div className="relative overflow-hidden w-full ">
                    ...
                    <div className="absolute flex justify-around items-center top-0 left-0 w-full h-full bg-opacity-50 max-h-96 bg-yellow-500 backdrop-brightness-30 ">
                        <div className=' flex flex-col gap-4 '>
                            ...
                            <span className='text-white flex gap-2'><FaRegCheckCircle />Access a Diverse Talent Pool</span>
                            <span className='text-white flex gap-2'><FaRegCheckCircle />Targeted Job Listings</span>
                            <span className='text-white flex gap-2'><FaRegCheckCircle />Build Your Brand</span>
                ...
                <div className="relative overflow-hidden w-full">
                    ...
                    <div className="absolute flex justify-around items-center top-0 left-0 w-full h-full bg-opacity-50 max-h-96 bg-yellow-500 backdrop-brightness-30 ">
                        <div className=' flex flex-col gap-4'>
                            ...
                            <span className='text-white flex gap-2'><FaRegCheckCircle />Access Exclusive Opportunities</span>
                            <span className='text-white flex gap-2'><FaRegCheckCircle />Connect with Top Employers</span>
                            <span className='text-white flex gap-2'><FaRegCheckCircle />Government, Private and NGO Jobs</span>
