...
const FounderNote = () => {
  return (
    ...
    <div className='flex flex-col '>
      ...
      <p>Divyang Career is not just another job portal; it’s a manifestation of our commitment to bridging the gap between talent and opportunity. Our vision is clear: to create a more inclusive and equitable workforce for various Government and private organizations. We believe that by providing a platform where individuals with disabilities can showcase their skills, experiences, and unique perspectives, we can connect them with employers who share our commitment to diversity.</p>
